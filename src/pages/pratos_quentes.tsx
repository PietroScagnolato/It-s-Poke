...
import Produto from '../assets/PratosQuentes.png'
import React from 'react'

function Pratos_quentes({navigation}) {
  return (
    <HStack flex={1}>
    <ScrollView background="#F04D4E" p={5}>
      ...
      <Text fontSize={40} color="white" fontWeight="bold" mb={5} mt={2}>Pratos quentes</Text>
